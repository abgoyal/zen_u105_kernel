...
SENSOR_INFO_T g_autotst_yuv_info =
{
    ...
    0,
    0, // i2c_dev_handler
    SENSOR_INTERFACE_CCIR601_8BITS
};
...
struct sensor_drv_cfg sensor_autotest = {     
    .sensor_pos = 1,     
    .sensor_name = "autotest",     
    .driver_info = &g_autotst_yuv_info,     
};     
     
static int __init sensor_autotest_init(void)     
{     
    printk("in sensor_autotest_init \n");     
    return dcam_register_sensor_drv(&sensor_autotest);     
}     
     
subsys_initcall(sensor_autotest_init);
